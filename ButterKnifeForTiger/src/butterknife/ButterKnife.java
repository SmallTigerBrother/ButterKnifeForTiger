 ...
 * finding views and attaching listeners by binding them with annotations.
 * <p>
 ...
 * </pre>
 * 
 * Binding can be performed directly on an {@linkplain #bind(Activity) activity}
 * , a {@linkplain #bind(View) view}, or a {@linkplain #bind(Dialog) dialog}.
 * Alternate objects to bind can be specified along with an
 * {@linkplain #bind(Object, Activity) activity},
 ...
 * <li>{@link #apply(List, Setter, Object)} &ndash; Applies a setter value to
 * each view.</li>
 * <li>{@link #apply(List, Property, Object)} &ndash; Applies a property value
 * to each view.</li>
 * </ul>
 * <p>
 ...
 * method bindings. If a view is optional add a {@code @Nullable} annotation
 * such as the one in the <a
 * href="http://tools.android.com/tech-docs/support-annotations"
 * >support-annotations</a> library.
 * 
 * <pre>
 * <code>
...
public final class ButterKnife
{
	...
	{
		/**
		 * Set the {@code value} on the {@code view} which is at {@code index}
		 * in the list.
		 */
	...
	static final Map<Class<?>, ViewBinder<Object>> INJECTORS = new LinkedHashMap<Class<?>, ViewBinder<Object>>();
	...
	/**
	 * Bind annotated fields and methods in the specified {@link Activity}. The
	...
	/**
	 * Bind annotated fields and methods in the specified {@link View}. The view
	 * and its children are used as the view root.
	 * 
	 * @param target
	 *            Target view for view binding.
	 */
	...
	/**
	 * Bind annotated fields and methods in the specified {@link Dialog}. The
	 * current content view is used as the view root.
	 * 
	 * @param target
	 *            Target dialog for view binding.
	 */
	...
	/**
	 * Bind annotated fields and methods in the specified {@code target} using
	 * the {@code source} {@link Activity} as the view root.
	 * 
	 * @param target
	 *            Target class for view binding.
	 * @param source
	...
	/**
	 * Bind annotated fields and methods in the specified {@code target} using
	 * the {@code source} {@link View} as the view root.
	 * 
	 * @param target
	 *            Target class for view binding.
	 * @param source
	...
	/**
	 * Bind annotated fields and methods in the specified {@code target} using
	 * the {@code source} {@link Dialog} as the view root.
	 * 
	 * @param target
	 *            Target class for view binding.
	 * @param source
	...
	/**
	 * Reset fields annotated with {@link FindView @FindView} and
	 * {@link FindViews @FindViews} to {@code null}.
	 * <p>
	 * This should only be used in the {@code onDestroyView} method of a
	 * fragment.
	 * 
	 * @param target
	 *            Target class for field unbind.
	 */
	...
	/**
	 * Set the {@code value} using the specified {@code setter} across the
	 * {@code list} of views.
	 */
	...
	/**
	 * Simpler version of {@link Dialog#findViewById(int)} which infers the
	 * target type.
	 */
	@SuppressWarnings({ "unchecked", "UnusedDeclaration" })
	// Checked by runtime cast. Public API.
